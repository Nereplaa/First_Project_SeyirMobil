...
BEGIN
    ...
    INSERT INTO @Vehicles (AracId, AracPlaka, BaseKm, ReadingCount, IntervalDays, StartDate) VALUES
        (1,  '34 RN 5944', 88605.94,  10, 1, '2024-07-08'),
        (2,  '41 KT 593',  195309.51,  8, 2, '2024-07-01'),
        (3,  '34 EGB 248', 45309.33,  10, 1, '2024-07-08'),
        (4,  '06 AB 1234', 120450.00, 12, 1, '2024-06-20'),
        (5,  '35 C 4521',  15200.00,   9, 3, '2024-06-15'),
        (6,  '16 DFT 45',  210800.50,  7, 4, '2024-07-05'),
        (7,  '42 M 78901', 62000.00,  11, 2, '2024-06-25'),
        (8,  '07 BC 902',  5400.00,    8, 3, '2024-07-01'),
        (9,  '61 PS 3345', 175600.00, 10, 2, '2024-06-18'),
        (10, '27 T 4456',  33000.00,  15, 1, '2024-07-10');
